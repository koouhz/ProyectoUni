...
CREATE DATABASE IF NOT EXISTS proyecto CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE proyecto;
...
CREATE TABLE troles (
  ...
  Estado tinyint(1) NOT NULL DEFAULT '1', -- Estado funcional
  EstadoLogico tinyint(1) NOT NULL DEFAULT '1', -- Borrado lógico
  FechaRegistro date DEFAULT (curdate()),
  PRIMARY KEY (IdRol)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO troles VALUES 
(1,'Cliente',1,1,'2025-08-17'),
(2,'Tecnico',1,1,'2025-08-17'),
(3,'Administrador',1,1,'2025-08-17');
...
CREATE TABLE tusuarios (
  ...
  EstadoLogico tinyint(1) NOT NULL DEFAULT '1',
  FechaRegistro date DEFAULT (curdate()),
...
(1,1,'Juan','Pérez','juan.cliente@example.com','cliente123',1,1,'2025-08-17'),
(2,2,'María','López','maria.tecnico@example.com','tecnico123',1,1,'2025-08-17'),
(3,3,'Carlos','García','carlos.admin@example.com','admin123',1,1,'2025-08-17');
...
(1,'Procesadores',1,1,'2025-08-17'),
(2,'Tarjetas Gráficas',1,1,'2025-08-17'),
(3,'Memorias RAM',1,1,'2025-08-17');
...
(1,1,'Intel Core i5',10,200.00,1,2,0,1,1,'2025-08-17'),
(2,1,'AMD Ryzen 5',8,180.00,0,1,1,1,1,'2025-08-17'),
(3,2,'NVIDIA GTX 1660',5,300.00,0,1,0,1,1,'2025-08-17'),
(4,2,'AMD Radeon RX 580',7,250.00,1,0,1,1,1,'2025-08-17'),
(5,3,'Kingston 8GB DDR4',15,40.00,0,3,2,1,1,'2025-08-17'),
(6,3,'Corsair 16GB DDR4',12,80.00,1,2,1,1,1,'2025-08-17');
...
INSERT INTO tcomputadoras VALUES (1,1,'PC 12456',1,1,'2025-08-17');
...
(1,2,1,'2025-08-17 19:16:34',NULL,500.00,'P',1),
(2,2,1,'2025-08-17 19:16:34','2025-08-17 19:16:34',750.00,'E',1);
...
INSERT INTO tmantenimientos VALUES (1,1,2,'2025-08-17',NULL,120.00,'P',1);
...
INSERT INTO treservas VALUES (1,1,'2025-08-17',330.00,'P',1);

-- TABLA DETALLE ENSAMBLE
...
INSERT INTO tdetallemantenimiento VALUES 
(1,1,1,1,1),
(2,1,5,1,1);
...
INSERT INTO tdetallereserva VALUES 
(1,1,3,1,1),
(2,1,6,1,1);
